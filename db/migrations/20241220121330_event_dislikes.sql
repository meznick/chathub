...
GRANT INSERT, SELECT, DELETE ON public.dislikes TO developer, chathub_service;
...
GRANT INSERT, SELECT, DELETE ON public.mismatches TO developer, chathub_service;
